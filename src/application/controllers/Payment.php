    ...
    public function vindi_notif_post() {
        ...
        try {
            ...
            if (isset($post->event) && isset($post->event->type) && $post->event->type == "charge_created") {
                ...
                // Activate User
                die("Activate client -> Recorrence created -> Set client pending by payment si o dia da cobrança é menor que o atual");
            }
