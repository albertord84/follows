            ...
            if ($this->validate_post_credit_card_datas($datas)) {
                ...
                if($BLOCKED_BY_PAYMENT){
                    ...
                    if($UPGRADE_PLANE){
                        ...
                        //crear recurrencia para +30dias con valor de nuevo plano
                        $recurrency_date = strtotime("+30 days", time());
                        $recurrency_value = $this->client_model->get_normal_pay_value($datas['client_update_plane']);
                    }else{
                ...
                if($resp_recurrency->success){
                    ...
                    $this->client_model->update_client_payment_key($this->session->userdata('id'),
